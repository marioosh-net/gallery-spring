			...
			<div class="left ainfo">
				...
				<div>
					<security:authorize ifAnyGranted="ROLE_ADMIN">
						...
						<a href="#" title="<spring:message code='text.description.scan'/>" onclick="openModal(this); return false;" id="scan-trigger-alb" class="modalInput modalInputClick" rel="#yesnoalbum" rev="loadingIcon('#scan-trigger-alb'); jQuery.get('<c:url value="/app/scan.html?refresh=1"/>', { path: '${album.path}'}, function(data){openOverlay('#scaned', data); jQuery('#scan-trigger-alb').text('<spring:message code="button.scan"/>');})"><spring:message code="button.scan"/></a>
