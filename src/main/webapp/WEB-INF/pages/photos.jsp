				...
				<security:authorize ifAllGranted="ROLE_ADMIN">
					<div class="thumb_options">
						...
						<div>
							...
							<img class="middle" src="images/picnik.png" height="16" width="16"/>&#160;<a target="_blank" href="http://www.picnik.com/service/?_apikey=224466f6d30d0e0887e24bfb017c971d&_export=<t:server/><t:context/>/picnik.html?id=${p['id']}&_export_title=save&_import=<t:server/><t:context/>/p2.html?hash=${p['hash']}${hash2}"><spring:message code="button.picnik"/></a>
							<%-- <img class="middle" src="images/picnik.png" height="16" width="16"/>&#160;<a target="_blank" href="http://www.picnik.com/service/?_apikey=224466f6d30d0e0887e24bfb017c971d&_export=<t:server/><t:context/>/picnik.html?id=${p['id']}&_export_agent=browser&_export_field=out&_export_title=save&_import=<t:server/><t:context/>/p2.html?hash=${p['hash']}${hash2}"><spring:message code="button.picnik"/></a> --%>
