			...
			<div class="left ainfo">
				...
				<div>
					<security:authorize ifAnyGranted="ROLE_ADMIN">
						...
						<a href="#" onclick="openModal(this); return false;" id="refresh-trigger" class="modalInput modalInputClick" rel="#yesnoalbum" rev="loadingIcon('#refresh-trigger'); jQuery.get('<t:context/>/refresh.html', { id: '${album.id}'}, function(data){if(data == '0') {openOverlay('#scaned', 'OK');} else {openOverlay('#scaned', 'Error');} jQuery('#refresh-trigger').text('<spring:message code="button.refresh"/>');})"><spring:message code="button.refresh"/></a>
						</div>
