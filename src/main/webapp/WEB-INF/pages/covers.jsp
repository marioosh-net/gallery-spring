...
<div class="covers">
	<div class="thumbs">
		<c:forEach items="${albums}" var="a" varStatus="i">
			<c:if test="${i.index == 0}">
				<div class="thumb_box">
					<a href="<t:context/>/index.html?a=${aid}&amp;pp=${ppage}&amp;p=${apage - 1}">
			...
			<div class="thumb_box">
				<a href="<t:context/>/index.html?a=${a.id}" class="thumb_link">
						...
						<div id="u${i.index}" class="thumb thumb_box_cover" style="float: none; background-image: url(<t:context/>/p.html?type=2&amp;id=${a.id}); "></div>
