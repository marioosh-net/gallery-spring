...
<t:layout>
	...
	<div class="left rightfixed">
		...
		<%-- footer --%>		
		<div id="footer-right">
			Inspired by <a href="http://minishowcase.net">minishowcase</a>. Powered by <a href="http://www.springsource.org/"><img style="vertical-align: text-bottom;" src="<c:url value="/images/spring2.png"/>"/></a>&nbsp;|&nbsp;<a href="http://marioosh.net">marioosh.net</a><%-- &nbsp;|&nbsp;<a href="<t:server-https/><c:url value='/'/>">https</a>--%>
