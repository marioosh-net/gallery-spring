...
function loading(selector) {
	jQuery(selector).html('<div style="padding: 5px;"><img src=\''+context+'/images/ajax-loader7.gif\'/>&#160;loading...</div>');
}
function loadingNoText(selector) {
	jQuery(selector).html('<div style="padding: 5px;"><img src=\''+context+'/images/ajax-loader7.gif\'/></div>');
}
function loadingIcon(selector) {
	jQuery(selector).html('<img src=\''+context+'/images/ajax-loader7.gif\'/>');
}
